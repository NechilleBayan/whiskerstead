...
export const ARCHETYPES: Record<PersonalityId, Archetype> = {
  planner: {
    ...
    actionBias: { cook: 1.35, serve: 1.3, gather: 1.15, build: 1.25, wander: 0.7, socialize: 0.85, reconcile: 1.2 },
    cultOpenness: 0.2,
    sleepShift: -0.15,
  },
  chaos: {
    ...
    actionBias: { explore: 1.6, wander: 1.5, fish: 0.9, steal: 1.4, socialize: 1.1, build: 0.8, chase: 1.8, reconcile: 1.1 },
    cultOpenness: 0.75,
    sleepShift: 0.25,
  },
  optimist: {
    ...
    actionBias: { socialize: 1.5, serve: 1.2, comfort: 1.4, fish: 1.1, gather: 1.05, reconcile: 1.5 },
    cultOpenness: 0.5,
    sleepShift: 0.0,
  },
  cynic: {
    ...
    actionBias: { gather: 1.3, wander: 1.2, socialize: 0.75, gossip: 1.4, serve: 0.85, join_cult: 0.4, reconcile: 0.7 },
    cultOpenness: 0.15,
    sleepShift: 0.1,
  },
  cryptic: {
    ...
    actionBias: { read: 1.5, explore: 1.3, wander: 1.2, socialize: 0.7, offer: 1.6, artifact_visit: 1.7, reconcile: 0.85 },
    cultOpenness: 0.3,
    sleepShift: 0.3,
  },
};
